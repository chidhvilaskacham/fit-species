...
import { Home, PlusCircle, TrendingUp, Settings, LogOut, Activity, Menu, X, Sparkles, Droplets, Target } from 'lucide-react';
            ...
            <div className="flex justify-between items-center h-16">
              <div className="flex items-center space-x-3 animate-slide-in-left">
                <div className="relative">
                  <div className="p-2 bg-gradient-to-br from-mint-400 to-sky-500 rounded-2xl shadow-lg">
              ...
              <div className="hidden md:flex items-center space-x-6 animate-slide-in-right">
                {userProfile && (
                  <div className="flex items-center space-x-3 px-4 py-2 glass-effect rounded-2xl">
                    <div className="w-8 h-8 bg-gradient-to-br from-mint-400 to-sky-500 rounded-full flex items-center justify-center">
              ...
              <div className="mt-8 pt-6 border-t border-neutral-200/50 dark:border-neutral-700/50">
                <div className="glass-effect rounded-2xl p-4">
                  <div className="flex items-center space-x-3 mb-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-mint-400 to-sky-500 rounded-full flex items-center justify-center">
                  ...
                  <div className="w-full bg-neutral-200 dark:bg-neutral-700 rounded-full h-2">
                    <div className="bg-gradient-to-r from-mint-400 to-sky-500 h-2 rounded-full w-3/4 transition-all duration-500"></div>
                  </div>
                </div>
              </div>
            </nav>
